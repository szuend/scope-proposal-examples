...
export function scopes(names) {
  ...
  const mainScopes = new OriginalScopeBuilder(names)
    .start(0, 0, 'global', undefined, ['globalThis'])
    .start(0, 0, 'module', undefined, ['Logger', 'inner', 'outer'])
    .start(3, 14, 'function', 'inner', ['y'])
    .end(5, 1)
    .start(7, 14, 'function', 'outer', ['z'])
    .end(9, 1)
    .end(13, 0)
    .end(13, 0)
    .build();
  ...
  const generatedRanges = new GeneratedRangeBuilder(names)
    ...
    .start(0, 0, { definition: { sourceIdx: 1, scopeIdx: 1 }})
    .start(0, 0, { definition: { sourceIdx: 1, scopeIdx: 4 }, callsite: { sourceIdx: 1, line: 11, column: 0 }, bindings: ['42']})
    .start(0, 0, { definition: { sourceIdx: 1, scopeIdx: 2 }, callsite: { sourceIdx: 1, line: 8, column: 2 }, bindings: ['42']})
    .start(0, 0, { definition: { sourceIdx: 0, scopeIdx: 2 }, callsite: { sourceIdx: 1, line: 4, column: 2 }, bindings: ['42']})
    .end(0, 16)
    .end(0, 16)
    .end(0, 16)
    .start(0, 16, { definition: { sourceIdx: 1, scopeIdx: 4 }, callsite: { sourceIdx: 1, line: 12, column: 0 }, bindings: ['null']})
    .start(0, 16, { definition: { sourceIdx: 1, scopeIdx: 2 }, callsite: { sourceIdx: 1, line: 8, column: 2 }, bindings: ['null']})
